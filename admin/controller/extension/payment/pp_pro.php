...
class ControllerExtensionPaymentPPPro extends Controller {
	...
	public function index() {
		...
		$data['text_cardinal'] = $this->language->get('text_cardinal');
		...
		$data['entry_cardinal_status'] = $this->language->get('entry_cardinal_status');
		$data['entry_cardinal_api_id'] = $this->language->get('entry_cardinal_api_id');
		$data['entry_cardinal_api_key'] = $this->language->get('entry_cardinal_api_key');
		$data['entry_cardinal_org_unit_id'] = $this->language->get('entry_cardinal_org_unit_id');
		...
		if (isset($this->error['cardinal_api_id'])) {
			$data['error_cardinal_api_id'] = $this->error['cardinal_api_id'];
		} else {
			$data['error_cardinal_api_id'] = '';
		}

		if (isset($this->error['cardinal_api_key'])) {
			$data['error_cardinal_api_key'] = $this->error['cardinal_api_key'];
		} else {
			$data['error_cardinal_api_key'] = '';
		}

		if (isset($this->error['cardinal_org_unit_id'])) {
			$data['error_cardinal_org_unit_id'] = $this->error['cardinal_org_unit_id'];
		} else {
			$data['error_cardinal_org_unit_id'] = '';
		}
		...
		if (isset($this->request->post['pp_pro_cardinal_status'])) {
			$data['pp_pro_cardinal_status'] = $this->request->post['pp_pro_cardinal_status'];
		} else {
			$data['pp_pro_cardinal_status'] = $this->config->get('pp_pro_cardinal_status');
		}
		
		if (isset($this->request->post['pp_pro_cardinal_api_id'])) {
			$data['pp_pro_cardinal_api_id'] = $this->request->post['pp_pro_cardinal_api_id'];
		} else {
			$data['pp_pro_cardinal_api_id'] = $this->config->get('pp_pro_cardinal_api_id');
		}
			
		if (isset($this->request->post['pp_pro_cardinal_api_key'])) {
			$data['pp_pro_cardinal_api_key'] = $this->request->post['pp_pro_cardinal_api_key'];
		} else {
			$data['pp_pro_cardinal_api_key'] = $this->config->get('pp_pro_cardinal_api_key');
		}
			
		if (isset($this->request->post['pp_pro_cardinal_org_unit_id'])) {
			$data['pp_pro_cardinal_org_unit_id'] = $this->request->post['pp_pro_cardinal_org_unit_id'];
		} else {
			$data['pp_pro_cardinal_org_unit_id'] = $this->config->get('pp_pro_cardinal_org_unit_id');
		}
	...
	protected function validate() {
		...
		if ($this->request->post['pp_pro_cardinal_status']) {
			if (!$this->request->post['pp_pro_cardinal_api_id']) {
				$this->error['warning'] = $this->language->get('error_warning');
				$this->error['cardinal_api_id'] = $this->language->get('error_cardinal_api_id');
			}

			if (!$this->request->post['pp_pro_cardinal_api_key']) {
				$this->error['warning'] = $this->language->get('error_warning');
				$this->error['cardinal_api_key'] = $this->language->get('error_cardinal_api_key');
			}

			if (!$this->request->post['pp_pro_cardinal_org_unit_id']) {
				$this->error['warning'] = $this->language->get('error_warning');
